package part_one.primitive_data_types;

/*
Section 1: Working with Java Primitive Data Types.
...
public class Foo {
    ...
    public static void main(String[] args) {
        ...
        // You can set all the numeric primitive data variables to a literal number
        // from 0 to 127.
        byte b = 127;
        char c = 127;
        short s = 127;
